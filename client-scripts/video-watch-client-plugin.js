async function register({ registerHook, peertubeHelpers }) {
    ...
    // 管理者メッセージを表示
    async function displayAdminMessage(type) {
        try {
    ...
    // メッセージコンテナを作成
    function createMessageContainer(message, style) {
        ...
        container.className += ` ${styleClasses[style] || styleClasses.default}`;
...
export { register };
//# sourceMappingURL=video-watch-client-plugin.js.map